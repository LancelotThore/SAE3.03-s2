...
var require_ical = __commonJS({
  "node_modules/ical/ical.js"(exports, module) {
      ...
      return {
        ...
        parseICS: function(str) {
          ...
          for (var i = 0, ii = lines.length, l2 = lines[0]; i < ii; i++, l2 = lines[i]) {
            ...
            ctx = self.handleObject(name, value, params, ctx, stack, l2) || {};
          }
          delete ctx.type;
          delete ctx.params;
          return ctx;
...
var isPresent, isNumber, isArray, range, repeat, toArray, split, pymod, divmod, empty, notEmpty, includes;
...
var __extends, dateutil, dateutil_default;
      ...
      var DateTime2 = (
        ...
        function(_super) {
          ...
          DateTime3.prototype.getWeekday = function() {
            return dateutil2.getWeekday(new Date(this.getTime()));
          };
          ...
          DateTime3.prototype.fixDay = function() {
            ...
            var daysinmonth = dateutil2.monthRange(this.year, this.month - 1)[1];
            ...
            while (this.day > daysinmonth) {
              ...
              if (this.month === 13) {
                this.month = 1;
                ++this.year;
                if (this.year > dateutil2.MAXYEAR) {
                  return;
                }
              }
              daysinmonth = dateutil2.monthRange(this.year, this.month - 1)[1];
            }
          };
          return DateTime3;
        }(Time)
      );
      dateutil2.DateTime = DateTime2;
    })(dateutil || (dateutil = {}));
    dateutil_default = dateutil;
  }
});
...
var init_masks = __esm({
  "node_modules/rrule/dist/esm/masks.js"() {
    init_helpers();
    M365MASK = repeat(1, 31).concat(repeat(2, 28), repeat(3, 31), repeat(4, 30), repeat(5, 31), repeat(6, 30), repeat(7, 31), repeat(8, 31), repeat(9, 30), repeat(10, 31), repeat(11, 30), repeat(12, 31), repeat(1, 7));
    M366MASK = repeat(1, 31).concat(repeat(2, 29), repeat(3, 31), repeat(4, 30), repeat(5, 31), repeat(6, 30), repeat(7, 31), repeat(8, 31), repeat(9, 30), repeat(10, 31), repeat(11, 30), repeat(12, 31), repeat(1, 7));
    M28 = range(1, 29);
    M29 = range(1, 30);
    M30 = range(1, 31);
    M31 = range(1, 32);
    MDAY366MASK = M31.concat(M29, M31, M30, M31, M30, M31, M31, M30, M31, M30, M31, M31.slice(0, 7));
    MDAY365MASK = M31.concat(M28, M31, M30, M31, M30, M31, M31, M30, M31, M30, M31, M31.slice(0, 7));
    NM28 = range(-28, 0);
    NM29 = range(-29, 0);
    NM30 = range(-30, 0);
    NM31 = range(-31, 0);
    NMDAY366MASK = NM31.concat(NM29, NM31, NM30, NM31, NM30, NM31, NM31, NM30, NM31, NM30, NM31, NM31.slice(0, 7));
...
// node_modules/rrule/dist/esm/iterinfo.js
...
var init_iterinfo = __esm({
  "node_modules/rrule/dist/esm/iterinfo.js"() {
    ...
    function() {
      ...
      Iterinfo2.prototype.easter = function(y, offset2) {
        if (offset2 === void 0) {
          offset2 = 0;
        }
        var a = y % 19;
      ...
      Iterinfo2.prototype.rebuildYear = function(year) {
        var rr = this.rrule;
        this.yearlen = dateutil_default.isLeapYear(year) ? 366 : 365;
        this.nextyearlen = dateutil_default.isLeapYear(year + 1) ? 366 : 365;
        var firstyday = new Date(Date.UTC(year, 0, 1));
        this.yearordinal = dateutil_default.toOrdinal(firstyday);
        this.yearweekday = dateutil_default.getWeekday(firstyday);
      ...
      Iterinfo2.prototype.rebuildMonth = function(year, month) {
        var rr = this.rrule;
        var ranges = [];
        if (rr.options.freq === rrule_default.YEARLY) {
        ...
        } else if (rr.options.freq === rrule_default.MONTHLY) {
      ...
      Iterinfo2.prototype.htimeset = function(hour, minute, second, millisecond) {
        var set = [];
        var rr = this.rrule;
        for (var i = 0; i < rr.options.byminute.length; i++) {
          ...
          for (var j = 0; j < rr.options.bysecond.length; j++) {
            ...
            set.push(new dateutil_default.Time(hour, minute, second, millisecond));
          }
        }
        dateutil_default.sort(set);
        return set;
      };
      Iterinfo2.prototype.mtimeset = function(hour, minute, second, millisecond) {
        var set = [];
        var rr = this.rrule;
        for (var j = 0; j < rr.options.bysecond.length; j++) {
          second = rr.options.bysecond[j];
      ...
      Iterinfo2.prototype.stimeset = function(hour, minute, second, millisecond) {
        return [new dateutil_default.Time(hour, minute, second, millisecond)];
      };
      return Iterinfo2;
    }();
...
var __extends2, CallbackIterResult, callbackiterresult_default;
...
function parseOptions(options) {
  ...
  if (!isPresent(opts.byweekday)) {
    ...
    for (var i = 0; i < opts.byweekday.length; i++) {
      ...
      var wd = wday;
      if (!wd.n || opts.freq > rrule_default.MONTHLY) {
  ...
  var timeset;
  if (opts.freq >= rrule_default.HOURLY) {
    timeset = null;
  } else {
    timeset = [];
    for (var i = 0; i < opts.byhour.length; i++) {
      ...
      for (var j = 0; j < opts.byminute.length; j++) {
        ...
        for (var k = 0; k < opts.bysecond.length; k++) {
          ...
          timeset.push(new dateutil_default.Time(hour, minute, second, millisecondModulo));
        }
      }
    }
    dateutil_default.sort(timeset);
  }
  ...
  for (var i = 0; i < attrs.length; i++) {
    ...
    switch (key) {
      ...
      case "BYDAY":
        ...
        break;
      case "DTSTART":
        options.dtstart = dateutil_default.untilStringToDate(value);
        break;
      case "UNTIL":
...
var init_util = __esm({
  "node_modules/luxon/src/impl/util.js"() {
    init_errors();
    ianaRegex = /[A-Za-z_+-]{1,256}(:?\/[A-Za-z_+-]{1,256}(\/[A-Za-z_+-]{1,256})?)?/;
  }
});
...
var singleton, LocalZone;
var init_localZone = __esm({
  "node_modules/luxon/src/zones/localZone.js"() {
    init_util();
    init_zone();
    singleton = null;
    LocalZone = class _LocalZone extends Zone {
      /**
...
var matchingRegex, dtfCache, typeToPos, ianaZoneCache, IANAZone;
var init_IANAZone = __esm({
  "node_modules/luxon/src/zones/IANAZone.js"() {
    init_util();
    init_zone();
    matchingRegex = RegExp(`^${ianaRegex.source}$`);
    dtfCache = {};
    typeToPos = {
      year: 0,
      month: 1,
...
var now, defaultZone, defaultLocale, defaultNumberingSystem, defaultOutputCalendar, throwOnInvalid, Settings;
...
var intlDTCache, intlNumCache, intlRelCache, sysLocaleCache, PolyNumberFormatter, PolyDateFormatter, PolyRelFormatter, Locale;
...
var contains, defaultGetText, ToText, totext_default;
var init_totext = __esm({
  "node_modules/rrule/dist/esm/nlp/totext.js"() {
    ...
    ToText = /** @class */
    function() {
      function ToText2(rrule, gettext, language) {
        if (gettext === void 0) {
      ...
      ToText2.prototype.toString = function() {
        ...
        this[esm_default.FREQUENCIES[this.options.freq]]();
...
function parseText(text, language) {
  ...
  function S() {
    ...
    switch (ttr.symbol) {
      case "day(s)":
        options.freq = esm_default.DAILY;
        if (ttr.nextSymbol()) {
          AT();
          F();
        }
        break;
      case "weekday(s)":
        options.freq = esm_default.WEEKLY;
        options.byweekday = [
          esm_default.MO,
          esm_default.TU,
          esm_default.WE,
      ...
      case "week(s)":
        ...
        break;
      case "hour(s)":
        options.freq = esm_default.HOURLY;
        if (ttr.nextSymbol()) {
          ON();
          F();
        }
        break;
      case "minute(s)":
        options.freq = esm_default.MINUTELY;
        if (ttr.nextSymbol()) {
          ON();
          F();
        }
        break;
      case "month(s)":
        options.freq = esm_default.MONTHLY;
        if (ttr.nextSymbol()) {
          ON();
          F();
        }
        break;
      case "year(s)":
        options.freq = esm_default.YEARLY;
        if (ttr.nextSymbol()) {
          ON();
          F();
        }
      ...
      case "sunday":
        ...
        options.byweekday = [esm_default[key]];
        if (!ttr.nextSymbol())
          return;
        while (ttr.accept("comma")) {
          ...
          options.byweekday.push(esm_default[wkd]);
          ttr.nextSymbol();
        }
        MDAYs();
        F();
      ...
      if (nth) {
        if (wkd) {
          ...
          if (!options.byweekday)
            options.byweekday = [];
          options.byweekday.push(esm_default[wkd].nth(nth));
        } else {
...
__export(nlp_exports, {
  fromText: () => fromText,
  isFullyConvertible: () => isFullyConvertible,
  parseText: () => parseText,
  toText: () => toText
});
...
var init_nlp = __esm({
  "node_modules/rrule/dist/esm/nlp/index.js"() {
    ...
    fromText = function(text, language) {
      ...
      return new esm_default(parseText(text, language) || void 0);
    };
    common = [
      "count",
      "until",
    ...
    totext_default.IMPLEMENTED[esm_default.HOURLY] = common;
    totext_default.IMPLEMENTED[esm_default.MINUTELY] = common;
    totext_default.IMPLEMENTED[esm_default.DAILY] = ["byhour"].concat(common);
    totext_default.IMPLEMENTED[esm_default.WEEKLY] = common;
    totext_default.IMPLEMENTED[esm_default.MONTHLY] = common;
    totext_default.IMPLEMENTED[esm_default.YEARLY] = ["byweekno", "byyearday"].concat(common);
    toText = function(rrule, gettext, language) {
      return new totext_default(rrule, gettext, language).toString();
    };
...
var getnlp, Days, DEFAULT_OPTIONS, defaultKeys, RRule, rrule_default;
var init_rrule = __esm({
  "node_modules/rrule/dist/esm/rrule.js"() {
    ...
    getnlp = function() {
      if (!getnlp._nlp) {
        getnlp._nlp = (init_nlp(), __toCommonJS(nlp_exports));
      }
      return getnlp._nlp;
    };
    Days = {
    ...
    function() {
      ...
      RRule2.prototype.toText = function(gettext, language) {
      ...
      RRule2.prototype._iter = function(iterResult) {
        ...
        var date = new dateutil_default.DateTime(dtstart.getUTCFullYear(), dtstart.getUTCMonth() + 1, dtstart.getUTCDate(), dtstart.getUTCHours(), dtstart.getUTCMinutes(), dtstart.getUTCSeconds(), dtstart.valueOf() % 1e3);
        ...
        var ii = new iterinfo_default(this);
        ii.rebuild(date.year, date.month);
        var getdayset = (_a = {}, _a[RRule2.YEARLY] = ii.ydayset, _a[RRule2.MONTHLY] = ii.mdayset, _a[RRule2.WEEKLY] = ii.wdayset, _a[RRule2.DAILY] = ii.ddayset, _a[RRule2.HOURLY] = ii.ddayset, _a[RRule2.MINUTELY] = ii.ddayset, _a[RRule2.SECONDLY] = ii.ddayset, _a)[freq];
        var timeset;
        var gettimeset;
        if (freq < RRule2.HOURLY) {
          timeset = this.timeset;
        } else {
          gettimeset = (_b = {}, _b[RRule2.HOURLY] = ii.htimeset, _b[RRule2.MINUTELY] = ii.mtimeset, _b[RRule2.SECONDLY] = ii.stimeset, _b)[freq];
          if (freq >= RRule2.HOURLY && notEmpty(byhour) && !includes(byhour, date.hour) || freq >= RRule2.MINUTELY && notEmpty(byminute) && !includes(byminute, date.minute) || freq >= RRule2.SECONDLY && notEmpty(bysecond) && !includes(bysecond, date.second)) {
            timeset = [];
          } else {
        ...
        while (true) {
          ...
          if (notEmpty(bysetpos) && notEmpty(timeset)) {
            ...
            for (var j = 0; j < bysetpos.length; j++) {
              ...
              var date_1 = dateutil_default.fromOrdinal(ii.yearordinal + i);
              var res = dateutil_default.combine(date_1, time);
            ...
            for (var j = start; j < end; j++) {
              ...
              var date_2 = dateutil_default.fromOrdinal(ii.yearordinal + currentDay);
              for (var k = 0; k < timeset.length; k++) {
                var time = timeset[k];
                var res = dateutil_default.combine(date_2, time);
                if (until && res > until) {
                  return this.emitResult(iterResult);
                }
                if (res >= dtstart) {
...
var __extends3, RRuleSet, rruleset_default;
var init_rruleset = __esm({
  "node_modules/rrule/dist/esm/rruleset.js"() {
    ...
    function(_super) {
      ...
      RRuleSet2.prototype.rdate = function(date) {
        ...
        if (!includes(this._rdate.map(Number), Number(date))) {
          ...
          dateutil_default.sort(this._rdate);
        }
      };
      ...
      RRuleSet2.prototype.exdate = function(date) {
        ...
        if (!includes(this._exdate.map(Number), Number(date))) {
          ...
          dateutil_default.sort(this._exdate);
        }
      };
      RRuleSet2.prototype.valueOf = function() {
        ...
        if (this._rdate.length) {
          result.push("RDATE:" + this._rdate.map(function(rdate) {
            return dateutil_default.timeToUntilString(rdate.valueOf());
          }).join(","));
        }
        ...
        if (this._exdate.length) {
          result.push("EXDATE:" + this._exdate.map(function(exdate) {
            return dateutil_default.timeToUntilString(exdate.valueOf());
          }).join(","));
        }
        return result;
      };
    ...
    rruleset_default = RRuleSet;
  }
});

// node_modules/rrule/dist/esm/rrulestr.js
var RRuleStr, rrulestr_default;
var init_rrulestr = __esm({
  "node_modules/rrule/dist/esm/rrulestr.js"() {
    ...
    function() {
      ...
      RRuleStr2.prototype._handle_DTSTART = function(rrkwargs, _, value, __) {
        var parms = /^DTSTART(?:;TZID=([^:=]+))?(?::|=)(.*)/.exec(value);
        var ___ = parms[0], tzid = parms[1], dtstart = parms[2];
        rrkwargs["dtstart"] = dateutil_default.untilStringToDate(dtstart);
        if (tzid) {
          rrkwargs["tzid"] = tzid;
        }
      };
      RRuleStr2.prototype._handle_int = function(rrkwargs, name, value) {
        rrkwargs[name.toLowerCase()] = parseInt(value, 10);
      };
      RRuleStr2.prototype._handle_int_list = function(rrkwargs, name, value) {
        rrkwargs[name.toLowerCase()] = value.split(",").map(function(x) {
          return parseInt(x, 10);
        });
      };
      RRuleStr2.prototype._handle_FREQ = function(rrkwargs, _, value, __) {
        rrkwargs["freq"] = RRuleStr2._freq_map[value];
      };
      RRuleStr2.prototype._handle_UNTIL = function(rrkwargs, _, value, __) {
        try {
          rrkwargs["until"] = dateutil_default.untilStringToDate(value);
        } catch (error) {
          throw new Error("invalid until date");
        }
      };
      RRuleStr2.prototype._handle_WKST = function(rrkwargs, _, value, __) {
        rrkwargs["wkst"] = RRuleStr2._weekday_map[value];
      };
      RRuleStr2.prototype._handle_BYWEEKDAY = function(rrkwargs, _, value, __) {
        var splt;
        var i;
        var j;
        var n2;
        ...
        for (i = 0; i < wdays.length; i++) {
          ...
          var weekday = new Weekday(RRuleStr2._weekday_map[w], n2);
          l2.push(weekday);
        }
        rrkwargs["byweekday"] = l2;
      };
      RRuleStr2.prototype._parseRfcRRule = function(line, options) {
        if (options === void 0) {
          options = {};
        }
        ...
        return new rrule_default(rrkwargs, !options.cache);
      };
      RRuleStr2.prototype._parseRfc = function(s2, options) {
        ...
        if (!options.forceset && lines.length === 1 && (s2.indexOf(":") === -1 || s2.indexOf("RRULE:") === 0)) {
          ...
          for (var i_1 = 0; i_1 < lines.length; i_1++) {
            ...
            if (name === "RRULE") {
              ...
              dtstart = dateutil_default.untilStringToDate(value);
              if (parms.length) {
          ...
          if (options.forceset || rrulevals.length > 1 || rdatevals.length || exrulevals.length || exdatevals.length) {
            rset = new rruleset_default(!options.cache);
            ...
            for (j = 0; j < rdatevals.length; j++) {
              ...
              for (k = 0; k < datestrs.length; k++) {
                datestr = datestrs[k];
                rset.rdate(dateutil_default.untilStringToDate(datestr));
              }
            }
            ...
            for (j = 0; j < exdatevals.length; j++) {
              ...
              for (k = 0; k < datestrs.length; k++) {
                datestr = datestrs[k];
                rset.exdate(dateutil_default.untilStringToDate(datestr));
              }
            }
      ...
      RRuleStr2.prototype.parse = function(s2, options) {
        if (options === void 0) {
          options = {};
        }
        var invalid = [];
        var keys = Object.keys(options);
        var defaultKeys2 = Object.keys(RRuleStr2.DEFAULT_OPTIONS);
        keys.forEach(function(key) {
        ...
        defaultKeys2.forEach(function(key) {
          if (!includes(keys, key))
            options[key] = RRuleStr2.DEFAULT_OPTIONS[key];
        });
        return this._parseRfc(s2, options);
      };
      RRuleStr2._weekday_map = {
        MO: 0,
        TU: 1,
        WE: 2,
        TH: 3,
      ...
      RRuleStr2._freq_map = {
        YEARLY: rrule_default.YEARLY,
        MONTHLY: rrule_default.MONTHLY,
        WEEKLY: rrule_default.WEEKLY,
        DAILY: rrule_default.DAILY,
        HOURLY: rrule_default.HOURLY,
        MINUTELY: rrule_default.MINUTELY,
        SECONDLY: rrule_default.SECONDLY
      };
      RRuleStr2.DEFAULT_OPTIONS = {
        dtstart: null,
        cache: false,
        unfold: false,
        forceset: false,
...
__export(esm_exports, {
  Frequency: () => Frequency,
  RRule: () => rrule_default,
  RRuleSet: () => rruleset_default,
  Weekday: () => Weekday,
  default: () => esm_default,
  rrulestr: () => rrulestr
});
var rruleStr, rrulestr, esm_default;
var init_esm = __esm({
  "node_modules/rrule/dist/esm/index.js"() {
    init_rrule();
    init_rruleset();
    ...
    init_types();
    init_weekday();
    rruleStr = new rrulestr_default();
    rrulestr = function() {
      return rruleStr.parse.apply(rruleStr, arguments);
    };
    esm_default = rrule_default;
  }
});

// node_modules/ical/node-ical.js
var require_node_ical = __commonJS({
  "node_modules/ical/node-ical.js"(exports) {
    var ical = require_ical();
    var fs = require_fs();
    exports.parseFile = function(filename) {
      return ical.parseICS(fs.readFileSync(filename, "utf8"));
    };
    var rrule = (init_esm(), __toCommonJS(esm_exports)).RRule;
...
// node_modules/ical/index.js
var require_ical2 = __commonJS({
  "node_modules/ical/index.js"(exports, module) {
    module.exports = require_ical();
...
export default require_ical2();
/*! Bundled license information:

rrule/dist/esm/nlp/index.js:
  (*!
